...
func (c *cache) SetTeam(ctx context.Context, team *model.Team, key string) (err error) {
...
func getTeamKey(key string) string {
	return fmt.Sprintf("team:%s", key)
}

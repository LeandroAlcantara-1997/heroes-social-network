...
func (m *MockTeam) RegisterTeam(ctx context.Context, team *team.TeamRequest) (*team.TeamResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegisterTeam", ctx, team)
...
func (mr *MockTeamMockRecorder) RegisterTeam(ctx, team interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegisterTeam", reflect.TypeOf((*MockTeam)(nil).RegisterTeam), ctx, team)
}
